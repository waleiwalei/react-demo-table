...
(function ($) {
    ...
    /**
     * 
     * @param {*} element  selectPicker的dom
     * @param {*} options  传递过来已经合并的属性
     */
    var Selectpicker = function (element, options) {
        ...
        this.setDisable = Selectpicker.prototype.setDisable;
        this.setEnable = Selectpicker.prototype.setEnable;
    ...
    Selectpicker.prototype = {
        ...
        init: function () {
            ...
            //先将新创建的dom：bootstrap-select外层dom 插入select-picker后，
            //然后再将select-picker插入到bootstrap-select内部的末尾
            this.$element
                .after(this.$newElement)
                .appendTo(this.$newElement);
            //用于显示和点击的button
            this.$button = this.$newElement.children('button');
            //.dropdown-menu 外层的div
        ...
        createDropdown: function () {
            ...
            var donebutton = this.multiple && this.options.doneButton ?
                ...
                '</div>'
                : '';
            //btn-group bootstrap-select是整个下拉框的外层容器
            var drop =
    ...
    function Plugin(option) {
        ...
        var chain = this.each(function () {
            ...
            if ($this.is('select')) {
                ...
                //依据以下代码，if条件是未建selectorpicker对象
                if (!data) {
                    //将两个默认值和传递来的options以及data()合并
                    var config = $.extend({}, Selectpicker.DEFAULTS, $.fn.selectpicker.defaults || {}, $this.data(), options);
                    config.template = $.extend({}, Selectpicker.DEFAULTS.template, ($.fn.selectpicker.defaults ? $.fn.selectpicker.defaults.template : {}), $this.data().template, options.template);
                    //将新建的Selector对象绑定在selectorpicker属性上，防止重复建新对象
