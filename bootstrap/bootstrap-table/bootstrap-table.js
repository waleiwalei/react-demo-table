...
(function ($) {
    ...
    /**
     * 仅当参数传递和所要求%s个数相符时才返回替换后字符串，否则返回‘’
     * sprintf("这里是s1%s,s2%s,s3%s", "1", "2","3");
     * 
     * @param {*} str 整个字符串
     * @param {*} str1...strn 需替换字符串
     */
    ...
    //创建包裹元素$container,及其子元素$toolbar,$pagination等，为表格添加样式
